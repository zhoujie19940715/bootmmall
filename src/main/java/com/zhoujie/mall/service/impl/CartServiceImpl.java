...
import com.zhoujie.mall.dao.CartMapper;
import com.zhoujie.mall.dao.ProductMapper;
import com.zhoujie.mall.pojo.Cart;
import com.zhoujie.mall.pojo.Product;
...
import com.zhoujie.mall.vo.CartProductVo;
...
public class CartServiceImpl implements ICartService {
   ...
   public ServerResponse<CartVo> list (Integer userId){
    ...
    private CartVo getCartVoLimit(Integer userId){
        ...
        //使用BigDecimal的字符串参数构造方法进行商业计算，避免小数点太多
        BigDecimal cartTotalPrice = new BigDecimal("0");

        if(CollectionUtils.isNotEmpty(cartList)){
            for(Cart cartItem : cartList){
                //使用Value Object cartProductVo对数据进行封装，方便响应给前端
                ...
                if(product != null){
                    ...
                    if(product.getStock() >= cartItem.getQuantity()){
                        ...
                        //库存不充足的时候，取产品的库存作为buyLimitCount
